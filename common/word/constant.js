...
libConstVar.paramsErr = {code:1000, message:"输入的参数错误, 请核对后再做操作"};
libConstVar.noWord = {code:1001, message:"不支持这种场景"};
...
libConstVar.createKeystoreErr = {code:1004, message:"创建keystore失败"};
